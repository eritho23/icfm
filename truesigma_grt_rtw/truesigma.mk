###########################################################################
## Makefile generated for component 'truesigma'. 
## 
## Makefile     : truesigma.mk
## Generated on : Thu Apr 23 15:15:00 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\truesigma.exe
...
COMPILER_COMMAND_FILE     = truesigma_comp.rsp
CMD_FILE                  = truesigma.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\truesigma.exe
...
DEFINES_STANDARD = -DMODEL=truesigma -DNUMST=2 -DNCSTATES=15 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)\rtw\c\src\rt_logging.c $(START_DIR)\truesigma_grt_rtw\rtGetInf.c $(START_DIR)\truesigma_grt_rtw\rtGetNaN.c $(START_DIR)\truesigma_grt_rtw\rt_nonfinite.c $(START_DIR)\truesigma_grt_rtw\truesigma.c $(START_DIR)\truesigma_grt_rtw\truesigma_data.c
...
OBJS = rt_logging.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj truesigma.obj truesigma_data.obj
...
{$(START_DIR)\truesigma_grt_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\truesigma_grt_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\truesigma_grt_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\truesigma_grt_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
rtGetInf.obj : "$(START_DIR)\truesigma_grt_rtw\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\truesigma_grt_rtw\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\truesigma_grt_rtw\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\truesigma_grt_rtw\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\truesigma_grt_rtw\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\truesigma_grt_rtw\rt_nonfinite.c"


truesigma.obj : "$(START_DIR)\truesigma_grt_rtw\truesigma.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\truesigma_grt_rtw\truesigma.c"


truesigma_data.obj : "$(START_DIR)\truesigma_grt_rtw\truesigma_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\truesigma_grt_rtw\truesigma_data.c"
